...
@endforeach
@endif
<form action="{{ route('masuk.action') }}" method="post">
@csrf
...
<p class="mb-0">
<a href="{{ route('daftar') }}" class="text-center">Belum ada akun? Daftar</a>
</p>
</div>
